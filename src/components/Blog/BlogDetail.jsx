...
const BlogDetailPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchBlogs = async () => {
            try {
                const response = await axios.get(`https://be.contienda.wealthfarming.org/api/posts?where[slug][equals]=${slug}`);
                ...
                const formattedBlogs = fetchedData.map((blog) => ({
                    ...
                    image: 'https://be.contienda.wealthfarming.org' + blog.image.url,
                }));
