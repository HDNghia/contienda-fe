...
const BlogPage = () => {
    ...
    useEffect(() => {
        const fetchBlogs = async () => {
            try {
                const response = await axios.get("https://be.contienda.wealthfarming.org/api/globals/post-recommend?depth=2");
                const { data } = response;
                ...
                const formattedBlogs = [
                    {
                        ...
                        image: `https://be.contienda.wealthfarming.org${data.post_1.image.url}`,
                    ...
                    },
                    {
                        ...
                        image: `https://be.contienda.wealthfarming.org${data.post_2.image.url}`,
                    ...
                    },
                    {
                        ...
                        image: `https://be.contienda.wealthfarming.org${data.post_3.image.url}`,
